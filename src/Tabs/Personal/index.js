...
import "./styles.css";
import replaceAppImg from "../../Assets/replaceapp.jpg";

const Personal = () => {
  return (
    <div class="st">
      <br/>
      <img src={replaceAppImg} alt="Replace App" />
        ...
        <div class="error-log-entry">
          ...
          <div class="log-entry-content">
            <div class="log-entry-description">
              El equipo no está configurado para entrar en suspensión automáticamente tras un
      ...
      <div class="log-entry">
        <div class="error-log-entry">
          <div class="log-entry-header">
            Directiva de energía:Tiempo de espera de suspensión deshabilitado (con corriente
            alterna)
          </div>
        ...
        <div class="error-log-entry">
          ...
          <div class="log-entry-content">
            ...
            <table>
              <tr>
                <td>
                  <span class="detail-name">Proceso solicitante</span>
                </td>
      ...
      <div class="log-entry">
        <div class="error-log-entry">
          ...
          <div class="log-entry-content">
            <div class="log-entry-description">
              El uso medio del procesador durante el seguimiento era alto. El sistema consumirá
              menos cuando el uso medio del procesador sea muy bajo. Revise el uso del procesador de
              los procesos individuales para determinar qué aplicaciones y servicios contribuyen en
              mayor medida al uso total del procesador.
            </div>

            <table>
              <tr>
                <td>
                  <span class="detail-name">Uso medio (%)</span>
                </td>
      ...
      <div class="log-entry">
        <div class="warning-log-entry">
          ...
          <div class="log-entry-content">
            <div class="log-entry-description">
              Un programa o servicio solicitó una resolución de temporizador inferior a la
              resolución de temporizador máxima de la plataforma.
            </div>

            <table>
              <tr>
                <td>
                  <span class="detail-name">Período solicitado</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Identificador de proceso solicitante</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Ruta de proceso solicitante</span>
                </td>
          ...
          <div class="log-entry-content">
            ...
            <table>
              ...
              <tr>
                ...
                <td>
                  \Device\HarddiskVolume3\Program
        ...
        <div class="warning-log-entry">
          ...
          <div class="log-entry-content">
            ...
            <table>
              <tr>
                <td>
                  <span class="detail-name">Tiempo de espera (segundos)</span>
                </td>
        ...
        <div class="warning-log-entry">
          ...
          <div class="log-entry-content">
            ...
            <table>
              <tr>
                <td>
                  <span class="detail-name">Nombre del proceso</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name"> Módulo </span>
                </td>

                <td>
                  <span class="detail-name"> Uso medio del módulo (%) </span>
                </td>
              </tr>
              ...
              <tr>
                <td>
                  \Device\HarddiskVolume3\Windows\Microsoft.NET\Framework64\v4.0.30319\clr.dll
                </td>
      ...
      <div class="log-entry">
        <div class="info-log-entry">
          ...
          <div class="log-entry-content">
            <div class="log-entry-description">
              La resolución de temporizador de plataforma predeterminada es 15,6 ms (15625000 ns) y
              se debe usar siempre que el sistema esté inactivo. Si se aumenta la resolución de
              ...
              <tr>
                <td>
                  <span class="detail-name">
                    Resolución de temporizador actual (unidades de 100 ns)
                  </span>
                </td>
      ...
      <div class="log-entry">
        <div class="info-log-entry">
          ...
          <div class="log-entry-content">
            <div class="log-entry-description">
              Pila de módulos responsables de la configuración de temporizador de plataforma más
              baja en este proceso.
            </div>
            ...
            <table>
              ...
              <tr>
                <td>
                  <span class="detail-name"> Pila de módulos de llamada </span>
                </td>
        ...
        <div class="info-log-entry">
          ...
          <div class="log-entry-content">
            ...
            <table>
              <tr>
                <td>
                  <span class="detail-name"> Nombre del plan </span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">GUID de plan</span>
                </td>
        ...
        <div class="info-log-entry">
          ...
          <div class="log-entry-content">
            ...
            <table>
              <tr>
                <td>
                  <span class="detail-name">Plan preconfigurado</span>
                </td>
        ...
        <div class="info-log-entry">
          ...
          <div class="log-entry-content">
            ...
            <table>
              <tr>
                <td>
                  <span class="detail-name">Modo de calidad</span>
                </td>
      ...
      <div class="log-entry">
        <div class="info-log-entry">
          ...
          <div class="log-entry-content">
            <div class="log-entry-description">
              Análisis correcto. No se encontraron problemas de eficiencia energética. No se
              devolvió ninguna información.
            </div>
            <span></span>
          </div>
        </div>
        ...
        <div class="info-log-entry">
          ...
          <div class="log-entry-content">
            ...
            <table>
              <tr>
                <td>
                  <span class="detail-name">Identificador de batería</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Fabricante</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Número de serie</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Composición química</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Largo plazo</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Sellado</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Capacidad de diseño</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Última carga completa</span>
                </td>
        ...
        <div class="info-log-entry">
          ...
          <div class="log-entry-content">
            ...
            <table>
              <tr>
                <td>
                  <span class="detail-name">Suspensión S1 compatible</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Suspensión S2 compatible</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Suspensión S3 compatible</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Suspensión S4 compatible</span>
                </td>
      ...
      <div class="log-entry">
        <div class="info-log-entry">
          ...
          <div class="log-entry-content">
            <div class="log-entry-description">
              El modo de espera conectado permite que el equipo entre en un modo de bajo consumo en
              el que siempre está activo y conectado. Si se admite el modo de espera conectado, se
              usará en lugar de los estados de suspensión del sistema.
            </div>

            <table>
              <tr>
                <td>
                  <span class="detail-name">Modo de espera conectado admitido</span>
                </td>
        ...
        <div class="info-log-entry">
          ...
          <div class="log-entry-content">
            ...
            <table>
              <tr>
                <td>
                  <span class="detail-name">Grupo</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Índice</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Recuento de estados de inactividad</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Tipo de estado de inactividad</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Frecuencia nominal (MHz)</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Porcentaje de rendimiento máximo</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Porcentaje de rendimiento más bajo</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Porcentaje de limitación más bajo</span>
                </td>
              ...
              <tr>
                <td>
                  <span class="detail-name">Tipo de controles de rendimiento</span>
                </td>
